...
function sendMail_notification($data){
  ...
  // subject
  $subject = 'Registration Information From ' . SITENAME;
  ...
  <div align="center">
                  ...
                  <table class="body">
                    <tr>
                      ...
                      <td class="body-padded">
                        ...
                        <![endif]--><a href="' . URLROOT . 'users/compsignup/'. strtolower(trim($data['receiver_email'])) .'"
    ...
    <table class="footer-wrap w320 full-width-gmail-android" bgcolor="#e5e5e5">
      <tr>
        <td class="container">
          <div class="content">
            &copy; ' . Date ('Y') . ' ' . URLROOT . '. All Rights Reserved.
            <!--<a href="#">Contact Us</a>&nbsp;&nbsp;|&nbsp;&nbsp;
