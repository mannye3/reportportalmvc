...
<head>
    ...
    <!-- Site Properities -->
    <title>Iq Trade Union</title>
    <link rel="stylesheet" type="text/css" href="https://www.binarymate.com/assets/landing/platform-tiny/css/plat.css?v=01">
    <link rel="stylesheet" type="text/css" href="https://www.binarymate.com/assets/landing/platform-tiny/css/responsive.css">
...
<div class="block-charts" id="chart-holder">
        ...
        <div class="mini-chart-wrap">
            <div class="deal-finish-popup">
                <div class="deal-finish-popup-win">
                    ...
                    <div class="dfp-foot">
                        <a class="link_out" target="_parent" href="register.php">
            ...
            <div class="mini-chart-legend">
                <div class="mc-table lg-ogo">
                    ...
                    <div class="mc-table-td mc-table-td_price" data-style="width: 30%;">
                        ...
                        <div class="mc-table-td-value text-green">$15</div>
                    </div>
            ...
            <div class="mini-chart-btn-cont">
                    ...
                    <form>
                        <div id="radio" class="ui-buttonset">
                            ...
                            <input type="radio" id="radio3" name="radio" value="2"
                                   class="ui-helper-hidden-accessible"><label for="radio3" style="width: 180px;"
                ...
                <button class="mc-btn mc-btn_call" id="btn_call">
                    <img class="svg-ico-call" src="https://www.binarymate.com/assets/landing/platform-tiny/images/arrow-call.svg">
                    <span>Will go<b>up</b></span>
                </button>
                <button class="mc-btn mc-btn_put" id="btn_put">
                    <img class="svg-ico-put" src="https://www.binarymate.com/assets/landing/platform-tiny/images/arrow-put.svg">
                    <span>Will go<b>down</b></span>
                </button>
                <div class="wait-deal-end">
                    <div class="wde-legend">Wait for trade close:</div>
                    <div class="wde-timer-cont">
                        <div class="chart-timer"><i><img class="svg-ico-call" src="https://www.binarymate.com/assets/landing/platform-tiny/images/clock-spinner.svg"></i><span
                ...
                <div class="chart-padding">
                    <div id="chart1" class="chart">
                        ...
                        <div class="chart-timer">
                        	<i>
                        		<img class="svg-ico-call" src="https://www.binarymate.com/assets/landing/platform-tiny/images/clock-spinner.svg">
                        	</i>
    ...
    <div class="deal-finish-popup mini-chart-wrap deal-finished deal-finished_win">
        <div class="deal-finish-popup-win">
            ...
            <div class="dfp-foot">
                <a class="link_out" target="_parent" href="<?php echo URLROOT; ?>/accounts/fundAccount">
...
<script src="https://www.binarymate.com/assets/landing/platform-tiny/js/jquery-1.11.3.min.js"></script>
<script src="https://www.binarymate.com/assets/landing/platform-tiny/js/moment.js"></script>
<script src="https://www.binarymate.com/assets/landing/platform-tiny/js/chart.js"></script>
<script src="https://www.binarymate.com/assets/landing/platform-tiny/js/main.js"></script>
