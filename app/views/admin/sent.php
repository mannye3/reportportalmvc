                                            ...
                                            <tbody>
                                                ...
                                                <tr class="">                                                    
                                                   <td>(<?php echo $count; ?>)</td>
                                                    ...
                                                    <td><a href="<?php echo URLROOT; ?>/admins/open_message_sent/<?php echo $sent_msg->msg_code; ?>"><?php echo $sent_msg->subject; ?></a></td>                             
                                                    <td><a href="<?php echo URLROOT; ?>/admins/open_message_sent/<?php echo $sent_msg->msg_code; ?>">
