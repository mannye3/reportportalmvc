                                        ...
                                        <table class="table table-hover table-borderless">                                            
                                            <tbody>
                                                ...
                                                <tr class="email-unread">                                                    
                                                    ...
                                                    <td><a href="<?php echo URLROOT; ?>/admins/open_message/<?php echo $inbox_msg->msg_code; ?>"><?php echo substr($inbox_msg->subject,0,35); ?></a></td>                             
                                                    <td><a href="<?php echo URLROOT; ?>/admins/open_message/<?php echo $inbox_msg->msg_code; ?>">
