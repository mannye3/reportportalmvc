                          ...
                          <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered w-100" id="dt-filter">
                                        ...
                                        <tbody>
                                             <?php  $count = 0; foreach($data['my_trades'] as $my_trades) :  $count++; ?>
                                            <tr>
                                                <td><?php echo $count; ?></td>
                                                <td><?php echo $my_trades->amount; ?></td>
                                                <td><?php echo $my_trades->asset_name; ?></td>
                                                <td><?php echo $my_trades->asset_type; ?></td>
                                              
                                                <td><?php echo $my_trades->trade_date; ?></td>
                                                 


                                                <td>
                                                    <?php   
                                        if ($my_trades->status  == 1){
