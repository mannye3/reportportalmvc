    <footer class="page-footer flexbox">
                    <div class="text-muted">2019 © <strong>Trade</strong>. All rights reserved</div>
                </footer><!-- END: Footer-->
            </div><!-- END: Content-->
        </div>
   ...
   <div class="sidenav-backdrop backdrop"></div>
    ...
    <!-- CORE PLUGINS-->
    <script src="<?php echo URLROOT; ?>/user/assets/vendors/jquery/dist/jquery.min.js"></script>
    <script src="<?php echo URLROOT; ?>/user/assets/vendors/bootstrap/dist/js/bootstrap.bundle.min.js"></script>
    <script src="<?php echo URLROOT; ?>/user/assets/vendors/metismenu/dist/metisMenu.min.js"></script>
    <script src="<?php echo URLROOT; ?>/user/assets/vendors/perfect-scrollbar/dist/perfect-scrollbar.min.js"></script><!-- PAGE LEVEL PLUGINS-->
    <script src="<?php echo URLROOT; ?>/user/assets/vendors/Flot/jquery.flot.js"></script>
    <script src="<?php echo URLROOT; ?>/user/assets/vendors/jquery.flot.tooltip/js/jquery.flot.tooltip.min.js"></script>
    <script src="<?php echo URLROOT; ?>/user/assets/vendors/Flot/jquery.flot.time.js"></script><!-- CORE SCRIPTS-->
    <script src="<?php echo URLROOT; ?>/user/assets/js/app.min.js"></script><!-- PAGE LEVEL SCRIPTS-->
    <script>
        $(function() {
